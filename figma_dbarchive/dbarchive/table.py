...
def insert_node(
    ...
    (
        ...
        kwargs.get('constraint_vertical'), kwargs.get('constraint_horizontal'), kwargs.get('layout_align'), kwargs.get('layout_mode'), kwargs.get('layout_positioning'), kwargs.get('layout_grow'), kwargs.get('primary_axis_sizing_mode'), kwargs.get('counter_axis_sizing_mode'), kwargs.get('primary_axis_align_items'), kwargs.get('counter_axis_align_items'), kwargs.get('gap'), kwargs.get('reverse'),
    ...
    cursor.execute(f'''INSERT OR REPLACE INTO nodes (
        ...
        constraint_vertical, constraint_horizontal, layout_align, layout_mode, layout_positioning, layout_grow, primary_axis_sizing_mode, counter_axis_sizing_mode, primary_axis_align_items, counter_axis_align_items, px(gap), reverse,
        fill_geometry, stroke_geometry,
        transition_duration, transition_easing, clips_content, is_mask, export_settings, mix_blend_mode, aspect_ratio
    ))
    conn.commit()
